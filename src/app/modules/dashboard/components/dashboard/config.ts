...
export const supportChartConfig2: BarChartComponentModel = {
  title: '',
...
export const featureChartConfig1: PieChartComponentModel = {
  title: '',
  chartType: ChartType.STANDARD,
  showInLegend: true,
  width: '350',
...
export const featureChartConfig2: BarChartComponentModel = {
  title: '',
  series: ['AWS', 'AZURE', 'GCP', 'OTHERS'],
  data: [],
  colors: [],
  height: '320'
};
